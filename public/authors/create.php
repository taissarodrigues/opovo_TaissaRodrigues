...
<body class="bg-light">
    <div class="container py-5">
        ...
        <form action="/opovo_TaissaRodrigues/public/authors/store.php" method="POST">
            <div class="col-lg-8">

                <div class="mb-3">
                    <label for="name" class="form-label">Nome completo</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Digite o nome do autor"
                        required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="exemplo@opovo.com.br"
                        required>
                </div>
